...
// Datos organizados por filas con información real del documento
const colaboradoresData = {
  ...
  practicantes: {
    titulo: "Colaboradores en Práctica",
    miembros: [
      {
        id: 14,
...
const Colaboradores = () => {
  ...
  // Auto-inicio después de 10 segundos
  useEffect(() => {
              ...
              <>
                ...
                <div className="w-full bg-amber-200 rounded-full h-1">
                  <div 
                    ...
                    style={{ width: `${((10 - initialCountdown) / 10) * 100}%` }}
                  ></div>
                </div>
              </>
            )}
      ...
      {selectedColaborador && (
        <div className="absolute top-4 right-4 z-20 bg-white/95 p-4 rounded-xl shadow-xl backdrop-blur-sm max-w-sm border border-amber-200">
          ...
          <div className="space-y-2 text-sm">
            <p><strong className="text-amber-800">Título:</strong> {selectedColaborador.titulo}</p>
            <p><strong className="text-amber-800">Participación:</strong> {selectedColaborador.participacion}</p>
          </div>
              ...
              <div className="flex items-center justify-between text-xs text-amber-600">
                <span>Siguiente cambio en:</span>
                    ...
                    <div className={`w-2 h-2 rounded-full mr-2 ${
                      timeLeft <= 2 ? 'bg-red-500 animate-pulse' : 'bg-green-500'
                    }`}></div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <svg className="absolute top-0 left-0 w-full h-full" style={{ width: '3000px', height: '2000px', transform: 'translate(-1500px, -1000px)' }}>
                {connections.map((connection, index) => (
                  <line 
                    key={`connection-${index}`}
                    x1={1500 + connection.from.posicion.x} 
                    y1={1000 + connection.from.posicion.y} 
                    x2={1500 + connection.to.posicion.x} 
              ...
              <div className="absolute text-center font-bold text-amber-800 text-xl bg-white/90 px-6 py-3 rounded-xl shadow-lg border border-amber-200" style={{ left: '-80px', top: '-270px' }}>
                {colaboradoresData.direccion.titulo}
              </div>
              <div className="absolute text-center font-bold text-amber-800 text-xl bg-white/90 px-6 py-3 rounded-xl shadow-lg border border-amber-200" style={{ left: '-120px', top: '-20px' }}>
                {colaboradoresData.colaboradores_inia.titulo}
              </div>
              <div className="absolute text-center font-bold text-amber-800 text-xl bg-white/90 px-6 py-3 rounded-xl shadow-lg border border-amber-200" style={{ left: '-150px', top: '160px' }}>
                {colaboradoresData.colaboradores_externos.titulo}
              </div>
              <div className="absolute text-center font-bold text-amber-800 text-xl bg-white/90 px-6 py-3 rounded-xl shadow-lg border border-amber-200" style={{ left: '-125px', top: '330px' }}>
