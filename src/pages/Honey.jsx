...
const Honey = () => {
  ...
  return (
    <div className="relative w-full min-h-[calc(100vh-88px)] flex flex-col">
      ...
      >
        <source src={miel} type="video/mp4" />
      ...
      <div className="relative z-20 flex-grow w-full overflow-y-auto pb-6">
        <div className="max-w-4xl mx-auto px-6 py-8 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <h2 className="text-xl font-bold text-amber-400 mb-4">Tipos de miel</h2>
              <ul className="space-y-2 text-gray-200">
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Miel monofloral</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Miel multifloral</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Miel de mielada</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Miel de bosque</span>
                </li>
              </ul>
            </div>
            ...
            >
              <h2 className="text-xl font-bold text-amber-400 mb-4">Incorruptibilidad de la miel</h2>
              <ul className="space-y-2 text-gray-200">
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Bajo contenido de agua</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Alta concentración de azúcares</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Propiedades antibacterianas</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Acidez natural</span>
                </li>
              </ul>
            </div>
            ...
            >
              <h2 className="text-xl font-bold text-amber-400 mb-4">Consumo de miel</h2>
              <ul className="space-y-2 text-gray-200">
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Usos culinarios</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Aplicaciones medicinales</span>
                </li>
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="text-amber-400 mr-2">•</span>
                  <span>Beneficios nutricionales</span>
                </li>
              </ul>
            </div>
          </div>
