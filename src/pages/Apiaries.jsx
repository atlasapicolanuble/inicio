...
import reproducion from '../components/images/apiario.mp4';
  ...
  return (
    <>
      ...
      <div className="md:hidden overflow-y-auto">
        ...
        <div className="min-h-screen h-screen w-full bg-white flex items-center justify-center px-6 py-8 relative flex-shrink-0">
          <div className="flex flex-col items-center text-center max-w-lg w-full">
            ...
            <h1 
              className={`text-gray-800 mb-10 tracking-wide font-bold transform transition-all duration-1000 ease-out ${
            ...
            <div className="mb-12 w-full space-y-8">
              ...
              >
                ...
                <span className="text-gray-800 font-medium text-center" style={{ fontSize: 'clamp(1.3rem, 5.5vw, 1.8rem)' }}>
                  Diseño y gestión de apiarios
                </span>
              </div>
            ...
            >
              <p className="text-gray-800 font-semibold text-center" style={{ fontSize: 'clamp(1.1rem, 4.5vw, 1.5rem)' }}>
      ...
      <div className="hidden md:flex flex-col md:flex-row h-full w-full bg-white overflow-hidden">
        ...
        <div className="w-full md:w-2/5 flex items-start justify-start pt-0 md:pt-2 lg:pt-3 xl:pt-4 pb-2 px-4 md:px-0 order-1 md:order-2 relative" style={{ marginLeft: '-120px' }}>
        ...
        {/* Texto "SECCIÓN 8" independiente del contenedor - posición absoluta desde el viewport */}
