...
import reproducion from '../components/images/temp.mp4';
import marco from '../components/images/marco.png';

export default function BeeTemperature() {
  ...
  return (
    <>
      {/* Vista mobile - contenido centrado sin video */}
      <div className="md:hidden">
        <div className="min-h-screen w-full bg-white flex items-center justify-center px-6 py-8 relative">
          <div className="flex flex-col items-center text-center max-w-lg w-full">
            ...
            {/* Lista de puntos con animación - textos largos */}
            <div className="mb-10 w-full space-y-6">
              ...
              >
                ...
                <span className="text-gray-800 font-medium text-center leading-tight" style={{ fontSize: 'clamp(1.1rem, 4.2vw, 1.5rem)' }}>
              ...
              >
                ...
                <span className="text-gray-800 font-medium text-center leading-tight" style={{ fontSize: 'clamp(1.1rem, 4.2vw, 1.5rem)' }}>
                  Temperatura y horas efectivas de vuelo
                </span>
              </div>
            </div>
      ...
      <div className="hidden md:flex h-full w-full bg-white overflow-hidden">
        ...
        <div className="w-2/5 flex items-start justify-center px-4 pt-4 pb-2 relative">
          ...
          {/* Texto "SECCIÓN 5" con animación del cuadrado y texto rotado */}
