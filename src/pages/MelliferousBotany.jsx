  ...
  return (
    <>
      ...
      <div className="md:hidden overflow-y-auto">
        ...
        <div className="min-h-screen h-screen w-full bg-white flex items-center justify-center px-6 py-8 relative flex-shrink-0">
          <div className="flex flex-col items-center text-center max-w-lg w-full">
            ...
            <h1 
              className={`text-gray-800 mb-8 tracking-wide font-bold transform transition-all duration-1000 ease-out ${
            ...
            {/* Lista de puntos con animación - 3 elementos */}
            <div className="mb-10 w-full space-y-5">
              ...
              >
                <div className={`w-4 h-4 bg-gray-800 rounded-full mr-4 flex-shrink-0 transform transition-all duration-500 ease-out ${
                  isVisible ? 'scale-100' : 'scale-0'
                }`} style={{ transitionDelay: '800ms' }}></div>
                <span className="text-gray-800 font-medium text-center" style={{ fontSize: 'clamp(1.1rem, 4.5vw, 1.6rem)' }}>
              ...
              >
                ...
                <span className="text-gray-800 font-medium text-center leading-tight" style={{ fontSize: 'clamp(1.1rem, 4.5vw, 1.6rem)' }}>
                  Calendarios de floraciones en tres sitios ecológicos
                </span>
              </div>
            </div>
            ...
            {/* Marco decorativo */}
            <div 
              className={`relative mb-8 transform transition-all duration-1000 ease-out ${
            ...
            >
              ...
              <div className="relative bg-transparent p-4 flex flex-col justify-center items-center h-full">
            ...
            >
              <p className="text-gray-800 font-semibold text-center" style={{ fontSize: 'clamp(1rem, 4vw, 1.3rem)' }}>
      ...
      <div className="hidden md:flex flex-col md:flex-row h-full w-full bg-white overflow-hidden">
        ...
        <div 
          className={`w-full md:w-3/5 relative overflow-hidden flex justify-center md:justify-start order-2 md:order-1 transform transition-all duration-1200 ease-out ${
        ...
        <div className="w-full md:w-2/5 flex items-start justify-start pt-0 md:-mt-1 lg:-mt-2 xl:-mt-3 pb-2 px-4 md:px-0 order-1 md:order-2 relative" style={{ marginLeft: '-120px' }}>
          {/* Contenido ajustado hacia la izquierda y arriba */}
          <div className="flex items-start justify-start w-full md:-ml-24 lg:-ml-28 xl:-ml-32">
            <div className="flex-1 max-w-none flex flex-col">
              {/* Título principal con animación de slide desde arriba - FUENTE AJUSTADA */}
              <h1 
                className={`text-gray-800 mb-0 tracking-wide font-bold text-left whitespace-nowrap transform transition-all duration-1000 ease-out ${
                  isVisible ? 'translate-y-0 opacity-100' : '-translate-y-20 opacity-0'
                }`}
                style={{ 
                  fontSize: 'clamp(1.4rem, 4.2vw, 4.2rem)',
                  transitionDelay: '200ms'
                }}
              >
                BOTÁNICA MELÍFERA
              ...
              {/* Lista de puntos con animación escalonada desde la derecha - FUENTES AJUSTADAS */}
              <div className="mb-0 w-full">
                <div 
                  className={`flex items-center mb-1 transform transition-all duration-800 ease-out ${
                    isVisible ? 'translate-x-0 opacity-100' : 'translate-x-16 opacity-0'
                  }`}
                  style={{ transitionDelay: '600ms' }}
                >
              ...
              <div 
                className={`relative mb-0 transform transition-all duration-1000 ease-out ${
                  isVisible ? 'scale-100 opacity-100 rotate-0' : 'scale-75 opacity-0 rotate-3'
                }`}
                style={{ 
                  transitionDelay: '1200ms',
              ...
              >
                ...
                <div className="relative bg-transparent p-3 sm:p-4 flex flex-col justify-center items-center h-full">
              ...
              >
                <p className="text-gray-800 font-semibold text-center" style={{ fontSize: 'clamp(0.9rem, 2.1vw, 1.4rem)' }}>
                  Marcelino Claret Merino Dr.
                </p>
              </div>
            </div>
