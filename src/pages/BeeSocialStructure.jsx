...
export default function BeeSocialStructure() {
  ...
  return (
    <>
      {/* Vista mobile - dos secciones verticales con scroll */}
      <div className="md:hidden">
        {/* Primera sección - Solo contenido de texto (pantalla completa vertical) */}
        <div className="min-h-screen w-full bg-white flex items-center justify-center px-6 py-8 relative">
          <div className="flex flex-col items-center text-center max-w-lg w-full">
            ...
            {/* Lista de puntos con animación */}
            <div className="mb-10 w-full">
              <div 
                className={`flex items-center justify-center mb-6 transform transition-all duration-800 ease-out ${
                  isVisible ? 'translate-x-0 opacity-100' : '-translate-x-16 opacity-0'
                }`}
                style={{ transitionDelay: '600ms' }}
              >
                <div className={`w-4 h-4 bg-gray-800 rounded-full mr-4 transform transition-all duration-500 ease-out ${
                  isVisible ? 'scale-100' : 'scale-0'
                }`} style={{ transitionDelay: '800ms' }}></div>
                <span className="text-gray-800 font-medium" style={{ fontSize: 'clamp(1.3rem, 5vw, 1.8rem)' }}>
            ...
            >
              <p className="text-gray-800 font-semibold text-center" style={{ fontSize: 'clamp(1.1rem, 4vw, 1.4rem)' }}>
        ...
        {/* Segunda sección - Solo video (pantalla completa vertical) */}
      ...
      {/* Vista desktop y tablet - layout original horizontal */}
      <div className="hidden md:flex h-full w-full bg-white overflow-hidden">
        ...
        >
          <video 
            ...
            loop
            muted
            className={`w-3/5 h-full object-cover transform transition-all duration-1500 ease-out ${
          ...
          {/* Overlay sutil - solo en el lado derecho */}
          <div 
        ...
        <div className="w-2/5 flex items-start justify-start pt-2 lg:pt-3 xl:pt-4 pb-2 px-4 relative" style={{ marginLeft: '-120px' }}>
          {/* Contenido ajustado hacia la izquierda y arriba */}
          <div className="flex items-start justify-start w-full -ml-24 lg:-ml-28 xl:-ml-32">
