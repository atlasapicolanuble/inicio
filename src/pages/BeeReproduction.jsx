...
import reproducion from '../components/images/reproduccion.mp4';
...
export default function BeeReproduction() {
  ...
  return (
    <>
      {/* Vista mobile - solo contenido de texto */}
          ...
          <div className="flex flex-col items-center text-center max-w-lg w-full">
            ...
            <div className="mb-10 w-full">
              ...
              >
                ...
                <span className="text-gray-800 font-medium text-center" style={{ fontSize: 'clamp(1.3rem, 5vw, 1.8rem)' }}>
